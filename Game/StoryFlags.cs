...
partial class Memory
{
    ...
    private struct StoryFlags
    {
        ...
        [FieldOffset(0xAD2 + 0x50)] public readonly byte _AD2 = 0;
        [FieldOffset(0xAD3 + 0x50)] public readonly byte _AD3 = 0;
        [FieldOffset(0xAD4 + 0x50)] public readonly byte _AD4 = 0;
        [FieldOffset(0xAD5 + 0x50)] public readonly byte _AD5 = 0;
        [FieldOffset(0xAD6 + 0x50)] public readonly byte _AD6 = 0;
        [FieldOffset(0xAD7 + 0x50)] public readonly byte _AD7 = 0;
        [FieldOffset(0xAD8 + 0x50)] public readonly byte _AD8 = 0;
        [FieldOffset(0xAD9 + 0x50)] public readonly byte _AD9 = 0;
